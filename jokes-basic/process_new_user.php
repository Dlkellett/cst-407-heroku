...
// Check to see if there are any special characters inside of the password.
preg_match('/[!@#$%^&*()]+/', $new_password1, $matches);
if (sizeof($matches) == 0)
{
    echo "The passowrd must have at least one special character.<br>";
    exit;
} 

// Check to see if the length of the password is greater to or equal to 8 characaters long.
